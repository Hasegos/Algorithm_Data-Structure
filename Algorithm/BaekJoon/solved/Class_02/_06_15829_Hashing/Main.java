...
/*
    ...
    문제 : APC에 온 것을 환영한다. 만약 여러분이 학교에서 자료구조를 수강했다면 해시 함수에 대해 배웠을 것이다.
          해시 함수란 임의의 길이의 입력을 받아서 고정된 길이의 출력을 내보내는 함수로 정의한다.
          함수는 무궁무진한 응용 분야를 갖는데, 대표적으로 자료의 저장과 탐색에 쓰인다.
...
 
    ...
    풀이 : java에서는 31의 49 제곱승 즉 long의 범위를 초과하는것은 표현할 수가 없다.
          그래서 이를 막고자 long의 범위를 초과 안시키게 mod M을 사용한다.
          M의 값인 "1234567891"를 범위가 초과하기전에 나눈 나머지로 만들어주면 long범위 초과없이 출력이 가능하다.
*/
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        long end = 0;
        // pow : 곱할 숫자를 미리 커지지않게 1234567891로 나눈 나머지 만들기
        long pow = 1;
        ...
        // 결과 도출간에도 1234567891이 넘을 수 있기에 나눈 나머지 만들기.
        System.out.println(end % 1234567891);      
    }
}
